...
use crate::ecs::{
    ...
    FollowCurrentWorkspaceMarker, FullWidthMarker, ManualStripOffset, NativeFullscreenMarker,
    RaiseWindow, SelectedVirtualMarker,
...
pub fn register_commands(app: &mut bevy::app::App) {
    ...
    app.add_systems(PreUpdate, (command_cycle_floating, command_move_floating, follow_window));
}
...
fn command_swap_focus(
    ...
    // Cross displays only when a tiled window had nothing to swap with.
